      ...
      <el-table :data="tableData" border style="width: 100%">
        ...
        <el-table-column label="操作" fixed="right" width="200">
          <template #default="{ row }">
            ...
            <el-button v-if="row.status === 0" link type="success" size="small" @click="handleToggleStatus(row, 1)">开始</el-button>
            <el-button v-if="row.status === 1" link type="warning" size="small" @click="handleToggleStatus(row, 2)">结束</el-button>
...
import { getSeckillList, createSeckill, updateSeckill, deleteSeckill, toggleSeckillStatus } from '@/api/seckill'
