    ...
    <div class="coupon-list">
        <el-card>
            ...
            <el-pagination v-model:current-page="pagination.page" v-model:page-size="pagination.size"
                ...
                @current-change="handleSearch" style="margin-top: 20px; justify-content: flex-end" />
        </el-card>
        ...
        <el-dialog v-model="createDialog.visible" title="创建优惠券" width="700px">
            <el-form :model="createDialog.form" label-width="120px">
                ...
                <el-form-item label="优惠值" required>
                    <el-input-number v-model="createDialog.form.value" :min="0" :precision="2"
                ...
                <el-form-item label="适用ID" v-if="createDialog.form.applicableType !== 1">
                    <el-input v-model="createDialog.form.applicableIds" type="textarea" :rows="2"
                ...
                <el-form-item label="有效期开始" v-if="createDialog.form.validityType === 1" required>
                    <el-date-picker v-model="createDialog.form.startsAt" type="datetime" placeholder="选择开始时间"
                        style="width: 100%;" />
                </el-form-item>

                <el-form-item label="有效期结束" v-if="createDialog.form.validityType === 1" required>
                    <el-date-picker v-model="createDialog.form.expiresAt" type="datetime" placeholder="选择结束时间"
                        style="width: 100%;" />
                </el-form-item>
        ...
        <el-dialog v-model="editDialog.visible" title="编辑优惠券" width="600px">
            <el-form :model="editDialog.form" label-width="120px">
                ...
                <el-form-item label="有效期开始">
                    <el-date-picker v-model="editDialog.form.validFrom" type="datetime" placeholder="选择日期时间" />
                </el-form-item>
                <el-form-item label="有效期结束">
                    <el-date-picker v-model="editDialog.form.validTo" type="datetime" placeholder="选择日期时间" />
                </el-form-item>
            </el-form>
            <template #footer>
        ...
        <el-dialog v-model="grantDialog.visible" title="发放优惠券" width="500px">
            <el-alert :title="`将发放优惠券: ${grantDialog.couponName}`" type="info" :closable="false"
                style="margin-bottom: 20px" />
            <el-form :model="grantDialog.form" label-width="100px">
                <el-form-item label="用户ID列表">
                    <el-input v-model="grantDialog.userIdsInput" type="textarea" :rows="5"
...
const handleSaveCreate = async () => {
    try {
        ...
        const createData = {
            ...form,
            // 全平台时applicableIds设为null，避免空字符串导致JSON错误
            applicableIds: form.applicableType === 1 ? null : (form.applicableIds || null)
        }
