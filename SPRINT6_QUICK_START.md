...
**问题**: 奖励配置 JSON 格式错误  
**解决**: 确保 rewardConfig 为有效 JSON，如`{"type":"points","value":100}`
...
**问题**: 用户等级不足  
**解决**: 检查活动的 requirementType 和 requirementValue，确保用户满足条件
...
**问题**: 库存不足  
**解决**: 检查 availableInventory 是否大于 0

**问题**: 超过限购数量  
**解决**: 检查 quantity 是否超过 limitPerUser
